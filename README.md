...
- 主界面仅变化的数位滚动，全部由上向下，旧数位下移、新数位从上方进入，动画延长至1.1秒。在线人数紧邻状态点。用户整行按个人余额从右侧以成员颜色填充，超过100%时底色满格、数值保留真实余额。
- “个人用量”紧邻曲线模式，点击在右侧切换为每日个人额度消耗图；默认柱状并平滑展开，支持曲线/柱状与悬停Token详情。“软件维护模式”在设置底部，仅保留名称和开关。修复维护曲线历史滑块。
