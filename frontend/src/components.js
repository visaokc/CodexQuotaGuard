...
export const TrendChart={
  ...
  setup(props){
    ...
    function quotaPercent(value,pending){return !props.data.quotaReady?'—':pending?'待更新':(value||0).toFixed(2)+'%';}
    function share(id){return props.data.quotaReady?(props.data.quotaTotals?.[id]||0).toFixed(1)+'%':'—';}
