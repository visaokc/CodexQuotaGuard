...
export const TrendChart={
  props:{data:{required:true},kind:String,color:{default:'#669cff'},comparisonTotal:{default:null}},
  setup(props){
    ...
    const tooltipStyle=computed(()=>{
      ...
      const box=bounds.value,multiple=series.value.length>1,tipWidth=multiple?190:122,tipHeight=43+(multiple?series.value.length*18+3:0);
