...
export const TrendChart={
  ...
  setup(props,{emit}){
    ...
    watch(()=>[props.kind,props.data.mode,props.viewEnd],()=>{hover.value=-1;});
    ...
    function cachePercent(value,missing,pending,estimated){return chartQuotaPercent(value,props.data.quotaReady&&!missing,pending,estimated);}
    ...
    const tooltipStyle=computed(()=>{
      ...
      const box=bounds.value,multiple=series.value.length>1,tipWidth=238,tipHeight=multiple?99+series.value.length*(props.data.mode==='cache'?25:47):113;
...
export const DonutChart={
  ...
  setup(props){
    ...
    function share(id){return chartQuotaPercent(props.quotaTotals[id],props.quotaReady,props.quotaStates[id]==='pending',props.quotaStates[id]==='estimated',1);}
    function cacheShare(id){return chartQuotaPercent(props.cacheTotals[id],props.quotaReady&&!props.cacheMissing[id],props.quotaStates[id]==='pending',props.quotaStates[id]==='estimated');}return {cacheShare,share,hover,arcs,compact};
  },
