...
notices = ['Syncthing v2.1.3-cqg1 | MPL-2.0 | Modified proxy compatibility build; see syncthing-source-notices/BUILD.md and modified-source.', 'Third-party software packaged with Codex Quota Guard 0.2.0', '',
