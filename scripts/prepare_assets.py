...
notices = ['Tailscale tsnet v1.102.3 | BSD-3-Clause | See licenses/tsnet for upstream and dependency notices.', 'Third-party software packaged with Codex Quota Guard 0.3.2', '',
