...
assert all('quota_guard.'+name in pyz.toc for name in ('analytics', 'web_host', 'web_controller', 'app_icon', 'shared_sync', 'shared_view', 'cycle_pair', 'shared_policy', 'shared_quota', 'pool_accounting', 'clean_start', 'maintenance', 'live_reporting'))
